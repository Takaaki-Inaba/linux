 ...
 * dentry.
 */
// ファイル名比較を効率的に行うためにファイル名のハッシュと長さを保持する
struct qstr {
	union {
		struct {
			HASH_LEN_DECLARE;
...
// ディレクトリ構造体
//
// d_parent, d_subdirs, d_childの関係図
// https://github.com/Takaaki-Inaba/linux-study/blob/master/figure/dentry-parent-child.svg
//
struct dentry {
